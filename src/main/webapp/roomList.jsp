                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">宿舍管理</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="/room">
                                                    <input type="hidden" name="method" value="insertRoom">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="form-group-inner">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   placeholder="如：D2623" name="code">
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <label>人数</label>
                                                            <input class="form-control touchspin1" type="text" value="6"
                                                                   name="num" style="height: 42px">
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <label>电话</label>
                                                            <input type="text" class="form-control"
                                                                   placeholder="如：18883349999" name="phone">
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <label>类型</label>
                                                            <input type="text" class="form-control"
                                                                   placeholder="如：四人间" name="type">
                                                        </div>
                                                    </div>
                                                    <br/>
                                        ...
                                        <tr>
                                            ...
                                            <td class="datatable-ct">
                                                <button id="btn_edit" type="button" class="btn btn-default"
                                                        data-toggle="modal" data-target="#upmodal${room.rid}">
                                                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
                                                </button>
                                                <button id="btn_delete" type="button" class="btn btn-default"
                                                        data-toggle="modal"
                                                        data-target="#delmodal${room.rid}">
                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
                                                </button>
                                            </td>
                                            <!-- 修改模态框（Modal） -->
                                            <div class="modal fade" id="upmodal${room.rid}" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="room">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="form-group-inner">
                                                                    ...
                                                                    <!--选中包含值的选项-->
                                                                    <script>
                                                                        $("#s1${room.rid}").val("${room.building.bdid}")
                                                                    </script>
                                                                </div>
                                                                <div class="form-group-inner">
                                                                    <label>寝室号</label>
                                                                    <input type="text" class="form-control"
                                                                           placeholder="10字以内字符" name="code"
                                                                           value="${room.code}">
                                                                </div>
                                                                <div class="form-group-inner">
                                                                    <label>人数</label>
                                            ...
                                            <!-- 删除模态框（Modal） -->
                                            <div class="modal fade" id="delmodal${room.rid}" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="container-fluid">
                                                            <h4>您确定要删除<span
                                                                    style="color: red">${room.code}</span>吗？删除后无法恢复！
                                                            </h4>
                                                            <br>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a href="/room?method=deleteRoomByRid&rid=${room.rid}"
